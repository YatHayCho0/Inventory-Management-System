...
public class Admin extends User_Encapsulation {
    public Admin(String UserID, String Name, String Password, String UserType, String DateRegister) {
        super(UserID, Name, Password, UserType, DateRegister);
    }
}
